class Notification < ApplicationRecord
  ...
  scope :todays_notifications, -> (user_id = nil){where(created_at: Date.yesterday.beginning_of_day..Date.yesterday.end_of_day).where(recipient_id: user_id)}
  ...
  def self.fetch_notification(filter = nil, user_id = nil)
    ...
    elsif filter.downcase == "last week"
    ...
    elsif filter.downcase == "last month"

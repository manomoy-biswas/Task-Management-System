...
RSpec.describe NotificationRelayWorker, type: :worker do
  ...
  describe "#perform" do
    ...
    context "with approved by task" do
      it "is expected to send a notification" do
    ...
    context "with submitted task" do
      it "is expected to send a notification" do
    ...
    context "with Quarterly task" do
      it "is expected to send a notification" do
    ...
    context "with Half_Yearly task" do
      it "is expected to send a notification" do
